...
def consolidar_arquivos_inadimplencia(caminho_base, pasta_saida, anos=range(2014, 2020)):
    """
    ...
    arquivo_saida = os.path.join(pasta_saida, 'consolidado_2014_a_2019.parquet')

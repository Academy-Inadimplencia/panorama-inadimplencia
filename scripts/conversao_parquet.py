...
pasta_entrada = "bases/2024"  
# Caminho onde serão salvos os arquivos Parquet
pasta_saida = "resultados/2024"
# Ano que deseja processar (formato: YYYY)
ano_a_processar = "2024"  # Ajustado para corresponder à pasta
...
def processar_arquivo(caminho_arquivo):
    ...
    try:
        ...
        for chunk in pd.read_csv(caminho_arquivo, sep=';', chunksize=tamanho_chunk, 
            ...
            # Separar em PF e PJ
            if 'cliente' in chunk.columns:
                df_pf = chunk[chunk['cliente'] == 'PF'].copy()
                df_pj = chunk[chunk['cliente'] == 'PJ'].copy()
